...
class TeamspaceManager:
    ...
    def edit(
        ...
        response = requests.patch(
            f"{API_SERVER_URL}/manage/admin/user-group/{teamspace.id}",
    ...
    def set_curator_status(
        ...
        response = requests.post(
            f"{API_SERVER_URL}/manage/admin/user-group/{test_teamspace.id}/set-curator",
    ...
    def wait_for_deletion_completion(
        ...
        while True:
            ...
            fetched_teamspace_ids = {
                teamspace.id for teamspace in fetched_teamspaces
            }
