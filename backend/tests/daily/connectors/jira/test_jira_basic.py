...
from enmedd.connectors.enmeddd_jira.connector import JiraConnector


@pytest.fixture
def jira_connector() -> JiraConnector:
    connector = JiraConnector(
        "https://enmedddai.atlassian.net/jira/software/c/projects/AS/boards/6",
...
def test_jira_connector_basic(jira_connector: JiraConnector) -> None:
    ...
    assert doc.id == "https://enmedddai.atlassian.net/browse/AS-2"
    ...
    assert section.link == "https://enmedddai.atlassian.net/browse/AS-2"
