...
# NOTE: if you are having problems accessing the Vanguard AI web UI locally (especially
...
# and is available in Vanguard AI EE
...
# restrict access to Vanguard AI to only users with emails from those domains.
# E.g. `VALID_EMAIL_DOMAINS=example.com,example.org` will restrict Vanguard AI
...
# If set, Vanguard AI will listen to the `expires_at` returned by the identity
...
# Save pages labels as Vanguard AI metadata tags
...
# Logs Vanguard AI only model interactions like prompts, responses, messages etc.
...
#####
# Headers config for basic bypass
#####
URL_USERAGENT = [
    ...
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_7_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.4.1 Mobile/\
        15E148 Safari/604.1",
    "Mozilla/5.0 (iPad; CPU OS 17_7_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.4.1 Mobile/15E148 \
        Safari/604.1",
    "Mozilla/5.0 (iPod touch; CPU iPhone 17_7_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.4.1 Mobile\
        /15E148 Safari/604.1",
