...
def prefix_user_email(user_email: str) -> str:
    ...
    This applies to both a Vanguard AI user and an External user, this is to make the query time
    more efficient"""
...
def prefix_external_teamspace(ext_teamspace_name: str) -> str:
    """Prefixes an external teamspace name to eliminate collision with user emails / Vanguard AI teamspaces."""
