...
def upgrade() -> None:
    ...
    op.add_column("assistant", sa.Column("builtin_assistant", sa.Boolean(), nullable=True))
...
def downgrade() -> None:
    ...
    op.add_column("assistant", sa.Column("default_assistant", sa.Boolean(), nullable=True))
