...
If you have any questions or need assistance, feel free to reach out to our support team at tech@vanguardai.io.</p> \
...
<p>Best regards,</p><p>The Vanguard AI Team</p>""",
            0,
        ),
        (
            2,
...
<p>If you did not request this email, please ignore it.</p><p></p><p>Best regards,</p><p>The Vanguard AI Team</p>""",
            0,
        ),
        (
            3,
            ...
            "Vanguard AI Two-Factor Authentication (2FA) Code",
            """<p>Dear {{full_name}},</p>
