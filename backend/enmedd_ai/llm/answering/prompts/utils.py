from enmedd_ai.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT
from enmedd_ai.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT_WITHOUT_CONTEXT
