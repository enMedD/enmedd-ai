...
from enmedd_ai.db.document_set import get_document_sets_by_ids
...
from enmedd_ai.db.models import StarterMessage
from enmedd_ai.db.models import Tool
...
def make_persona_private(
    ...
    if group_ids:
        raise NotImplementedError("VanguardAI does not support private Personas")
...
def create_update_persona(
    ...
    try:
        ...
        versioned_make_persona_private = fetch_versioned_implementation(
            "enmedd_ai.db.persona", "make_persona_private"
        )
