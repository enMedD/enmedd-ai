...
def get_model_app() -> FastAPI:
    application = FastAPI(
        title="VanguardAI Model Server", version=__version__, lifespan=lifespan
    )
...
if __name__ == "__main__":
    logger.info(
        f"Starting VanguardAI Model Server on http://{MODEL_SERVER_ALLOWED_HOST}:{str(MODEL_SERVER_PORT)}/"
    )
