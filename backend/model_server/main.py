...
def get_model_app() -> FastAPI:
    application = FastAPI(
        title="Vanguard AI Model Server", version=__version__, lifespan=lifespan
    )
...
if __name__ == "__main__":
    logger.notice(
        f"Starting Vanguard AI Model Server on http://{MODEL_SERVER_ALLOWED_HOST}:{str(MODEL_SERVER_PORT)}/"
    )
