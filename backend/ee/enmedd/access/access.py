...
def _get_access_for_documents(
    ...
    teamspace_info: dict[str, list[str]] = {
        document_id: teamspace_names
        for document_id, teamspace_names in fetch_teamspaces_for_documents(
            db_session=db_session,
            document_ids=document_ids,
        )
    }
    ...
    for document_id, non_ee_access in non_ee_access_dict.items():
        ...
        # To avoid collisions of teamspace namings between connectors, they need to be prefixed
