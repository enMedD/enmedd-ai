...
$COMPOSE_CMD -f docker-compose.prod.yml run  --name enmedd-ai --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yml -p enmedd-ai up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yml -p enmedd-ai up --force-recreate -d
