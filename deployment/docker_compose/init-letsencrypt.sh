...
$COMPOSE_CMD -f docker-compose.prod.yml run  --name arnold-ai --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yml -p arnold-ai up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yml -p arnold-ai up --force-recreate -d
