  ...
  return (
    <CustomTooltip
      trigger={
        ...
        ${size === "xxlarge" ? "w-12 h-12" : size === "xlarge" ? "w-10 h-10" : size === "large" ? "w-8 h-8" : "w-6 h-6"}`}
          ...
          <div
            ...
            ${size === "xxlarge" ? "w-12 h-12" : size === "xlarge" ? "w-10 h-10" : size === "large" ? "w-10 h-10" : "w-6 h-6"} `}
          >
            {createSVG(
