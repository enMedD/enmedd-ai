      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for Arnold AI. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow Arnold AI to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the Arnold AI integration."
                ),
              })}
              initialValues={{
