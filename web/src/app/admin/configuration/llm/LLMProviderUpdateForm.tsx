...
//       : z.string(),
//     api_base: llmProviderDescriptor.api_base_required
//       ? z.string().min(1, { message: "API Base is required" })
//       : z.string(),
//     api_version: llmProviderDescriptor.api_version_required
//       ? z.string().min(1, { message: "API Version is required" })
//       : z.string(),
//     custom_config: llmProviderDescriptor.custom_config_keys
//       ? z.object(
//           llmProviderDescriptor.custom_config_keys.reduce(
//             (acc, customConfigKey) => {
//               if (customConfigKey.is_required) {
//                 acc[customConfigKey.name] = z.string().min(1, {
//                   message: `${customConfigKey.name} is required`,
//                 });
//               }
//               return acc;
//             },
...
//     fast_default_model_name: z.string().nullable(),
//     is_public: z.boolean().refine((val) => val === true, {
//       message: "is_public is required",
//     }),
//     groups: z.array(z.number()).optional(),
//     display_model_names: z.array(z.string()).optional(),
//   });
