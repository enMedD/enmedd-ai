...
//   is_public: z.boolean(),
//   document_set_ids: z.array(z.number()),
...
//     })
//   ),
//   enabled_tools_map: z.record(z.any()), // Adjust record type if necessary
//   icon_color: z.string(),
...
//       is_public: existingAssistant?.is_public ?? defaultPublic,
//       document_set_ids:
//         existingAssistant?.document_sets?.map(
...
//         : null,
//       include_citations:
//         existingAssistant?.prompts[0]?.include_citations ?? true,
//       llm_relevance_filter: existingAssistant?.llm_relevance_filter ?? false,
//       llm_model_provider_override:
//         existingAssistant?.llm_model_provider_override ?? null,
//       llm_model_version_override:
...
//         tool_ids: enabledTools,
//         remove_image: removeAssistantImage,
//         uploaded_image: values.uploaded_image ?? null,
//       });
...
//   function toggleToolInValues(values: FormValues, toolId: number) {
//     const updatedEnabledToolsMap = {
//       ...values.enabled_tools_map,
//       [toolId]: !values.enabled_tools_map[toolId],
//     };
...
//   function searchToolEnabled(values: FormValues) {
//     return searchTool && values.enabled_tools_map[searchTool.id] ? true : false;
//   }

//   function currentLLMSupportsImageOutput(
//     values: FormValues,
//     providerDisplayNameToProviderName: Map<string, string>,
//     defaultProviderName: string,
//     defaultModelName: string
//   ) {
//     return checkLLMSupportsImageOutput(
//       providerDisplayNameToProviderName.get(
//         values.llm_model_provider_override || ""
//       ) ||
//         defaultProviderName ||
...
//                   <img
//                     src={URL.createObjectURL(form.getValues("uploaded_image"))}
//                     alt="Uploaded assistant icon"
//                     className="object-cover w-12 h-12 rounded-full"
//                   />
//                 ) : existingAssistant?.uploaded_image_id &&
...
//                 <label className="flex items-center w-full px-4 py-2 text-left rounded cursor-pointer gap-x-2 hover:bg-background-100">
//                   <CameraIcon />
//                   Upload {form.getValues("uploaded_image") && " New "} Photo
//                   <input
//                     type="file"
//                     accept="image/*"
//                     className="hidden"
...
//             triggerFinalPromptUpdate(
//               e.target.value,
//               form.getValues("task_prompt"),
//               searchToolEnabled(form.getValues())
//             );
//           }}
//           defaultHeight="h-40"
//           maxHeight={150}
...
//         <div>
//           <div className="flex items-center gap-x-2 pt-6">
//             <div className="block text-base font-medium">Default AI Model </div>
//             <CustomTooltip trigger={<FiInfo size={12} />}>
//               Select a Large Language Model (Generative AI model) to power this
//               Assistant
//             </CustomTooltip>
//           </div>
//           <p className="my-1 text-sm text-subtle">
//             Your assistant will use the user&apos;s set default unless otherwise
//             specified below.
//             {admin &&
//               user?.preferences.default_model &&
//               `  Your current (user-specific) default model is ${getDisplayNameForModel(destructureValue(user?.preferences?.default_model!).modelName)}`}
...
//                   onSelect={(selected) => {
//                     if (
//                       selected !== form.getValues("llm_model_provider_override")
//                     ) {
//                       form.setValue("llm_model_version_override", null);
//                     }
//                     form.setValue("llm_model_provider_override", selected);
//                   }}
//                 />
//               </div>
...
//                     const { modelName, provider, name } =
//                       destructureValue(value);
//                     form.setValue("llm_model_version_override", modelName);
...
//                         toggleToolInValues(form.getValues(), searchTool.id);
//                       }}
//                       disabled={ccPairs.length === 0}
//                     />
//                   </div>
...
//                                 are specified, the Assistant will search through
//                                 all available documents in order to try and
//                                 respond to queries.
//                               </>
//                             </SubLabel>
//                           </div>
...
//                                           form.getValues("document_set_ids");
//                                         const ind = documentSetIds.indexOf(
//                                           documentSet.id
//                                         );
//                                         let isSelected = ind !== -1;
//                                         return (
...
//                                   form.setValue("num_chunks", Number(value));
//                                 }
//                               }}
//                             />
...
//                 label={internetSearchTool.display_name}
//                 onChange={() => {
//                   toggleToolInValues(form.getValues(), internetSearchTool.id);
//                 }}
//               />
//             )}
...
//                     subtext={tool.description}
//                     onChange={() => {
//                       toggleToolInValues(form.getValues(), tool.id);
//                     }}
//                   />
//                 ))}
//               </>
