        ...
        <Formik
          ...
          onSubmit={async (values, formikHelpers) => {
            ...
            if (response.ok) {
              ...
              setPopup({
                message: isUpdate
                  ? `Error updating VanguardAI Bot config - ${errorMsg}`
                  : `Error creating VanguardAI Bot config - ${errorMsg}`,
                type: "error",
              });
            }
          }}
            ...
            <Form>
              <div className="px-6 pb-6">
                ...
                <TextArrayField
                  ...
                  subtext={
                    <div>
                      ...
                      <br />
                      <br />
                      <i>NOTE</i>: you still need to add VanguardAI Bot to the
                ...
                <SelectorFormField
                  ...
                  subtext={
                    <>
                      If set to Citations, VanguardAI Bot will respond with a direct
                      answer with inline citations. It will also provide links
                      to these cited documents below the answer. When in doubt,
                      choose this option.
                      <br />
                      <br />
                      If set to Quotes, VanguardAI Bot will respond with a direct
                      answer as well as with quotes pulled from the context
                      documents to support that answer. VanguardAI Bot will also
                ...
                <SectionHeader>When should VanguardAI Bot respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @VanguardAI Bot Only"
                  subtext="If set, VanguardAI Bot will only respond when directly tagged"
                />
                <BooleanFormField
                  name="respond_to_bots"
                  label="Responds to Bot messages"
                  subtext="If not set, VanguardAI Bot will always ignore messages from Bots"
                />
                <TextArrayField
                  name="respond_team_member_list"
                  label="Team Members Emails"
                  subtext={`If specified, VanguardAI Bot responses will only be 
                  visible to members in this list. This is
                  useful if you want VanguardAI Bot to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of VanguardAI Bot's response / throw 
                ...
                <BooleanFormField
                  ...
                  label="Should enMedD VanguardAI give a “Still need help?” button?"
                  subtext={`If specified, VanguardAI Bot's response will include a button at the bottom 
                  ...
                  <TextArrayField
                    ...
                    subtext={
                      <div>
                        ...
                        handle. For example, &apos;enMedD VanguardAI Team&apos; or
                        &apos;vanguard-ai-team&apos;.
                        <br />
                        <br />
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents VanguardAI Bot uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that VanguardAI Bot should search
                                through. If left blank, VanguardAI Bot will search
