...
export const sortAndGroupConnectors = (
  connectors: ConnectorIndexingStatus<any, any>[],
  selectedSort: string | null,
  sortOrder: "asc" | "desc",
  selectedGroup: string | null,
  ...
  const groupedConnectors = groupConnectorsByStatus(connectors, selectedGroup);

  // Sort connectors within each group
  for (const groupKey in groupedConnectors) {
    groupedConnectors[groupKey] = sortConnectors(
      groupedConnectors[groupKey],
      selectedSort,
      sortOrder,
      null,
      groupOrder
