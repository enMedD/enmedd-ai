...
export function ChatPage({
  ...
  const [initialSelectedAssistant, setInitialSelectedAssistant] = useState<
    Assistant | undefined
  >(() => {
    ...
    } else if (defaultSelectedAssistantId !== undefined) {
      return filteredAssistants.find(
        (assistant) => assistant.id === defaultSelectedAssistantId
      );
    } else {
  ...
  }, [defaultSelectedAssistantId, filteredAssistants, messageHistory]);
