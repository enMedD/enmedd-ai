...
export const TeamspaceSidebar = ({ teamspace }: TeamspaceSidebarProps) => {
  return (
    <div className="w-[500px] h-full bg-background border-l">
      ...
      <div className="flex flex-col items-center p-6 pt-14 w-full">
        ...
        <div className="w-full flex flex-col gap-4 pt-14">
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea placeholder="Enter email" className="max-h-96" />
            ...
            {teamspace.users.length > 0 ? (
              <div className="pt-4 flex flex-wrap">
                ...
                {teamspace.users.length > 4 && (
                  <div className="bg-background w-10 h-10 rounded-full -ml-3 flex items-center justify-center text-sm font-semibold">
                    +{teamspace.users.length - 4}
                  </div>
                )}
              </div>
          ...
          <div className="rounded-md bg-muted w-full p-4 min-h-32 flex flex-col justify-between">
            ...
            <div className="pt-4 flex flex-wrap">
              ...
              <div className="bg-success w-10 h-10 rounded-full -ml-3 flex items-center justify-center font-semibold text-inverted text-lg">
                J
              </div>
              <div className="bg-warning w-10 h-10 rounded-full -ml-3 flex items-center justify-center font-semibold text-inverted text-lg">
                I
              </div>
              <div className="bg-destructive w-10 h-10 rounded-full -ml-3 flex items-center justify-center font-semibold text-inverted text-lg">
                F
              </div>
              <div className="bg-background w-10 h-10 rounded-full -ml-3 flex items-center justify-center text-sm font-semibold">
                +21
