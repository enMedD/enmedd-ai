        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving Vanguard AI for your organization. This will replace 'Vanguard AI' everywhere in the UI.`}
            ...
            <div className="mt-4">
              <TextFormField
                ...
                to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${
                  values.application_name || "Vanguard AI"
                }!".`}
